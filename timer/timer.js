...
function renderCal(){
    ...
    getFare(date)
    console.log("render cal called");
}

function getFareFor(month, year){
    var fareDate = "20121125";
    var fareVal  = 3079;
    var fareObj = {"20121125":3079, "20121127":1424, "20121210":5412, "20121211":2145, "20121212":1137, "20121231":3636};
    return fareObj;
}
...
Calendar = function(){
    ...
    function getFare(date, month, year){
        // console.log("date: " + date + ", month: "+ month + ", year: "+year);
        var fareObj = getFareFor(month, year);
        var dateStr = date.toString();
        var monthStr = month.toString();
        var yearStr = year.toString();
        var fareVal;

        for (var i in fareObj){
            if(yearStr+monthStr+dateStr == i){
                fareVal = "$ "+fareObj[i];
                // console.log("date: "+ date +" - " + "month: "+ month +" - " + i + " : " + fareObj[i]);
                return fareVal;
            }else{
                fareVal = "<br>";
                // return fareVal;
